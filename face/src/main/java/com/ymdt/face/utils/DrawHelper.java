...
import com.ymdt.face.widget.FaceRectView;

import java.util.List;

/**
 * 绘制人脸框帮助类，用于在{@link com.ymdt.face.widget.FaceRectView}上绘制矩形
 */
public class DrawHelper {
    ...
    public DrawHelper initPreviewSize(Size size) {
        this.mPreviewSize = size;
        return this;
    }

    public DrawHelper initCanvasSize(Size size) {
        this.mCanvasSize = size;
        return this;
    }

    public DrawHelper initOrientation(int cameraDisplayOrientation) {
        this.mCameraDisplayOrientation = cameraDisplayOrientation;
        return this;
    }
    public DrawHelper initCameraId(int cameraId){
...
//    }
    ...
    public Rect adjustRect(Rect ftRect) {
        ...
        int canvasWidth = mCanvasSize.getWidth();
        int canvasHeight = mCanvasSize.getHeight();
